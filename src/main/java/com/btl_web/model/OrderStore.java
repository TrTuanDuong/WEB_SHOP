...
public final class OrderStore {
    ...
    public static final class Order {
        ...
        public Order(String id, String username, String customerName, String shippingAddress, 
                     LocalDateTime createdAt, BigDecimal total, List<OrderLine> lines, OrderStatus status) {
            this.id = id;
